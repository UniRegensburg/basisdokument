  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex flex-col justify-center items-center z-50">
        <div
          ref={popupRef}
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-[600px]">
          <div
            ref={moveIconRef}
            className="float-right text-darkGrey bg-lightGrey rounded-sm opacity-50 hover:opacity-100 p-[2px] items-center">
            <ArrowsOutCardinal size={18} />
          </div>
          <div className="p-8 bg-white rounded-lg content-center shadow-lg space-y-8 overflow-y-auto mt-[20px]">
            ...
            <span className="text-sm">
              Fügen Sie Beweise zu diesem Beitrag hinzu. Sie können dabei auch
              auf Anlagen verweisen, welche Sie später mit versenden. Beweise,
              die hier hinzugefügt wurden, können auch in anderen Beiträgen
              referenziert werden.
            </span>
        ...
        <ErrorPopup isVisible={isEditErrorVisible}>
          <div className="flex flex-col items-center justify-center space-y-6">
            <p className="text-center text-base">
              Dieser Beweis wird in keinem anderen Beitrag referenziert. Wenn
              Sie ihn aus diesem Beitrag löschen, wird er für das gesamte
              Basisdokument entfernt.
            </p>
            <p className="text-center text-base">
              Um den Beweis zu einem anderen Beitrag zu referenzieren, müssen
              Sie ihn dort erneut erstellen.
            </p>
