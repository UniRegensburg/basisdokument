        ...
        {hasImageFile && (
          <>
            <div className="bg-offWhite rounded-md pl-3 pr-3 p-2 my-2 flex flex-row justify-between items-center gap-2">
              {(imageFile ? "PDF/TIFF hochgeladen: " : "PDF/TIFF hochladen: ") +
                imageFilename}
                ...
                {true && (
                  <button
                    onClick={() => {
                      if (isPlaintiff) {
                        setCurrPlaintiffFileVolume(
                          currPlaintiffFileVolume - getImageFileSize(imageFile)
                        );
                      } else {
                        setCurrDefendantFileVolume(
                          currDefendantFileVolume - getImageFileSize(imageFile)
                        );
                      }
            ...
            <div className="flex flex-row w-full gap-2 mb-2 items-center">
              <label htmlFor="fileVolume">
                {isPlaintiff ? "Klagepartei" : "Beklagtenpartei"} Dateivolumen
                verbleibend:
              </label>
