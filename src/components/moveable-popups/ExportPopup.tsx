import { Info, Trash, Upload, CaretDown, CaretUp } from "phosphor-react";
    ...
    <>
      ...
      <div className="flex flex-row items-center justify-left gap-2">
        <input
          ...
          onChange={() =>
            setDownloadEvidencesAdditionally(!downloadEvidencesAdditionally)
          }
        />
        <div className="flex flex-row gap-0.5">
          <span className="font-semibold">
      ...
      <div className="flex flex-row items-center justify-left gap-2">
        <input
          ...
          onChange={() => setDontDownloadAttachments(!dontDownloadAttachments)}
        />
        <div className="flex flex-row gap-0.5">
          <span className="font-semibold">Anlagen nicht herunterladen</span>
          <Tooltip
