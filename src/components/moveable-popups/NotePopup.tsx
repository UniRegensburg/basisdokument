...
import { useNotes, useUser, useCase } from "../../contexts";
import { INote, IEntry } from "../../types";
  ...
  return (
    <>
      <div className="flex gap-2 mx-20 p-3 bg-offWhite rounded-lg font-bold text-darkGrey">
        ...
        <p className="text-sm">
          Alle Notizen sind privat und können nicht von den anderen Parteien
          eingesehen werden. Sie können die Notiz zu jedem Zeitpunkt bearbeiten
          und löschen.
        </p>
      </div>
